...
{
  for_ctx := start_anonymous_context(ctx)
  ...
  type_check_rhs_expression(&for_ctx, expression_node, for_ctx.root.identifiers["bool"]) or_return
  ...
  end_anonymous_context(ctx, &for_ctx)
