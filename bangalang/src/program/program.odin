...
{
  program.identifiers["atomic_i8"] = ast.make_node({ type = .identifier, value = "atomic_i8" })
  program.identifiers["atomic_i16"] = ast.make_node({ type = .identifier, value = "atomic_i16" })
  program.identifiers["atomic_i32"] = ast.make_node({ type = .identifier, value = "atomic_i32" })
  program.identifiers["atomic_i64"] = ast.make_node({ type = .identifier, value = "atomic_i64" })
  program.identifiers["bool"] = ast.make_node({ type = .identifier, value = "bool" })
  program.identifiers["cint"] = ast.make_node({ type = .identifier, value = "cint" })
  program.identifiers["cuint"] = ast.make_node({ type = .identifier, value = "cuint" })
  program.identifiers["f32"] = ast.make_node({ type = .identifier, value = "f32" })
  program.identifiers["f64"] = ast.make_node({ type = .identifier, value = "f64" })
  program.identifiers["i8"] = ast.make_node({ type = .identifier, value = "i8" })
  program.identifiers["i16"] = ast.make_node({ type = .identifier, value = "i16" })
  program.identifiers["i32"] = ast.make_node({ type = .identifier, value = "i32" })
  program.identifiers["i64"] = ast.make_node({ type = .identifier, value = "i64" })
  program.identifiers["u8"] = ast.make_node({ type = .identifier, value = "u8" })
  program.identifiers["u16"] = ast.make_node({ type = .identifier, value = "u16" })
  program.identifiers["u32"] = ast.make_node({ type = .identifier, value = "u32" })
  program.identifiers["u64"] = ast.make_node({ type = .identifier, value = "u64" })

  allocator_type := ast.make_node({ type = .procedure_type })
  append(&allocator_type.children, ast.make_node({ type = .group, value = "[parameters]" }))
